...
export default function CommoditiesPage() {
    return (
        <DashboardShell
            ...
            unauthenticatedMessage="You must sign in to view the commodities briefing."
            hero={null}
                ...
                {items
                    ...
                    : Array.from({ length: 4 }).map((_, i) => (
                        <div key={`skeleton-${i}`} style={{ border: "1px solid rgba(255,255,255,0.08)", borderRadius: 12, padding: "16px" }}>
                            <div style={{ height: 80, opacity: 0.2, background: "rgba(255,255,255,0.1)", borderRadius: 8 }} />
                        </div>
                    ))}
            </section>

            <section aria-label="Live board" style={{ border: "1px solid var(--table-border, rgba(255,255,255,0.08))", borderRadius: 12, overflow: "hidden", opacity: items ? 1 : 0.6 }}>
